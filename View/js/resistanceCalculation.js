$(document).ready(function(){
    ...
    $("#currentTypeSelect").on('change', function() {
        ...
        inputs['DC'] = new Array('Voltage/Current','Voltage/Power', 'Current/Power');
        inputs['AC Single Phase'] = new Array('Voltage/Current','Voltage/Power', 'Current/Power','Impedance');
        inputs['AC Three Phase'] = new Array('Voltage/Current','Voltage/Power', 'Current/Power','Impedance');
    ...
    $("#currentCalculation").click(function() {
        ...
        if(currentType == "DC") {
            if(inputSelect == "Voltage/Current"){
                ...
                calculatedValue = input2/(input1*input1); 
            }
            ...
            if(inputSelect == "Voltage/Current"){
                ...
                calculatedValue = input2/(1.73*input1*input1);
            } else if(inputSelect == "Impedance"){
                calculatedValue = input1*0.9;
            } 
        }

        var calculatedString = '<h4>Resistance is : '+calculatedValue+' ohm</h4>';
